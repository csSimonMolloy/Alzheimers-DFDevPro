trigger DF_ThirdPartiesTrigger on DF_Third_Parties__c (after delete, after insert, after undelete, 
after update, before delete, before insert, before update) {
    ...
    System.debug('****** DF_ThirdPartiesTrigger ******');

    // Delegate responsibility to the DF_ContactTriggerHandler Class.
    DF_ThirdPartiesTriggerHandler handler = new DF_ThirdPartiesTriggerHandler(Trigger.isExecuting, Trigger.size);
