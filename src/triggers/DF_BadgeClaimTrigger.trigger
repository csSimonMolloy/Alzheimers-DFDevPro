trigger DF_BadgeClaimTrigger on Badge_Claim__c (after delete, after insert, after undelete, 
after update, before delete, before insert, before update) {
    ...
    System.debug('****** DF_BadgeClaimTrigger ******');

    // Delegate responsibility to the DF_BadgeClaimTriggerHandler Class.
    DF_BadgeClaimTriggerHandler handler = new DF_BadgeClaimTriggerHandler(Trigger.isExecuting, Trigger.size);
